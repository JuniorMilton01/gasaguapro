...
function Vendas(props) {
  const [venda, setVenda] = React.useState({ cliente: '', produto: '', quantidade: 1, valor: '' });
...
function Clientes(props) {
  const [cliente, setCliente] = React.useState({ nome: '', telefone: '', endereco: '' });
...
function Estoque(props) {
  const [produto, setProduto] = React.useState({ nome: '', tipo: 'gas', quantidade: 0, preco: 0 });
